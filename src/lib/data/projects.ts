...
export interface Project {
  ...
  minCapital: number;
  /**
   * How much of the round is taken, 0-100. A marketplace signal, not a
   * model figure: it says what other investors have already done, which is
   * why it must never be an estimate. PLACEHOLDER like the rest of this
   * file — it has to come from the CRM before launch.
   */
  reservedPercent: number;
  featured?: boolean;
  summary: string;
  /** Web-sized photo, generated by scripts/prepare-photos.ps1. */
  image?: string;
  /** Duotone gradient — used wherever a project has no photo yet. */
  imageFrom: string;
  imageTo: string;
...
export const PROJECTS: Project[] = [
  {
    ...
    image: "/photo/projekty/vinohrady-byt-3kk.jpg",
    imageFrom: "#16324b",
    imageTo: "#1f8a70",
    metrics: [
  ...
  },
  {
    ...
    image: "/photo/projekty/smichov-investicni-byt.jpg",
    imageFrom: "#16324b",
    imageTo: "#2f6fed",
    metrics: [
  ...
  },
  {
    ...
    image: "/photo/projekty/brno-kralovo-pole.jpg",
    imageFrom: "#16324b",
    imageTo: "#1f8a70",
    metrics: [
  ...
  },
  {
    ...
    image: "/photo/projekty/plzen-portfolio-3-byty.jpg",
    imageFrom: "#16324b",
    imageTo: "#6d5bd0",
    metrics: [
  ...
  },
  {
    ...
    image: "/photo/projekty/ostrava-poruba-1kk.jpg",
    imageFrom: "#16324b",
    imageTo: "#f59e0b",
    metrics: [
  ...
  },
  {
    ...
    image: "/photo/projekty/karlin-loft-2kk.jpg",
    imageFrom: "#16324b",
    imageTo: "#486581",
    metrics: [
