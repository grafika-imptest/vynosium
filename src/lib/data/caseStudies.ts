...
export interface CaseStudy {
  ...
  hasVideo?: boolean;
  /** Before/after photos, generated by scripts/prepare-photos.ps1. */
  beforeImage?: string;
  afterImage?: string;
  /** Duotone fallback for a study with no photography yet. */
  beforeFrom: string;
  beforeTo: string;
  afterFrom: string;
  afterTo: string;
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    hasVideo: true,
    beforeImage: "/photo/pred-po/vinohrady-2plus1-pred.jpg",
    afterImage: "/photo/pred-po/vinohrady-2plus1-po.jpg",
    beforeFrom: "#243b53",
    beforeTo: "#486581",
    afterFrom: "#16324b",
    afterTo: "#1f8a70",
  ...
  },
  {
    ...
    beforeImage: "/photo/pred-po/karlin-loft-pred.jpg",
    afterImage: "/photo/pred-po/karlin-loft-po.jpg",
    beforeFrom: "#243b53",
    beforeTo: "#486581",
    afterFrom: "#16324b",
    afterTo: "#1f8a70",
  ...
  },
  {
    ...
    beforeImage: "/photo/pred-po/brno-zabovresky-pronajem-pred.jpg",
    afterImage: "/photo/pred-po/brno-zabovresky-pronajem-po.jpg",
    beforeFrom: "#243b53",
    beforeTo: "#486581",
    afterFrom: "#16324b",
    afterTo: "#2f6fed",
  ...
  },
  {
    ...
    beforeImage: "/photo/pred-po/plzen-portfolio-pred.jpg",
    afterImage: "/photo/pred-po/plzen-portfolio-po.jpg",
    beforeFrom: "#243b53",
    beforeTo: "#486581",
    afterFrom: "#16324b",
    afterTo: "#6d5bd0",
